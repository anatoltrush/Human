...
namespace man{
    ...
    float angle3Pts0_180(const QVector3D &pt0, QVector3D &mid, const QVector3D &pt1);
    Angle angle3Pts0_180Reverse(const QVector3D &pt0, QVector3D &mid, const QVector3D &pt1);
